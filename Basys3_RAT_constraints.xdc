...
create_pblock pblock_RO_PUF_Internal0
set_property IS_SOFT TRUE [get_pblocks pblock_RO_PUF_Internal0]



create_pblock pblock_RO_PUF_Internal0_1
add_cells_to_pblock [get_pblocks pblock_RO_PUF_Internal0_1] [get_cells -quiet [list RO_PUF_Internal0]]
resize_pblock [get_pblocks pblock_RO_PUF_Internal0_1] -add {CLOCKREGION_X1Y0:CLOCKREGION_X1Y0}
